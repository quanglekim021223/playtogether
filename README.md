...
Mesh này có mặt sân phẳng, bờ dốc chuyển từ cát khô qua cát ẩm đến đá ướt, cùng các cụm đá/đá cuội xám-nâu được chôn vào bờ thay vì lặp theo hàng. Script tạo năm mẫu đá chi tiết rồi decimate thành mesh dùng trong game, UV vào một atlas PBR dùng chung; màu vertex ở phần chân hòa đá vào cát và decal mờ tăng tiếp xúc với mặt đất. Các PNG base-color, normal, roughness và AO của cát/đá được xuất cạnh GLB để kiểm tra hoặc tái sử dụng. Nó chỉ thay phần nhìn; mặt phẳng vật lý và vị trí các công trình vẫn do server quản lý. Nếu GLB không tải được, game dùng đảo geometry cũ làm dự phòng.
...
- Tay cầm lọc rung nhỏ của ngón tay cho preview mượt nhưng dùng đúng tọa độ thô khi thả để cú bắn không bị trễ. Máy rung nhẹ một lần khi vượt các mốc lực 25%, 50%, 75% và 100%. Kéo ngắn vẫn bắn được ở lực thấp; sau khi kéo ra khỏi tâm, vòng **HỦY** mới được kích hoạt và kéo trở lại vòng rồi thả sẽ không bắn. Xoay dọc giữa lượt, mất kết nối, chuyển tab hoặc bị hủy cảm ứng cũng hủy thao tác đang diễn ra.
...
Cảnh vịnh biển dùng bầu trời shader và đại dương ba tầng LOD bám theo camera. Mặt nước kết hợp tám lớp Gerstner Wave, hai normal map thủ tục chạy chéo, Fresnel phản chiếu HDR, màu theo độ sâu, foam ở đỉnh sóng/đường bờ và splash particle tại đá ven nước. Địa hình GLB giữ vertex color, normal map và roughness rồi được phủ chi tiết cát triplanar ở runtime; rock kit dùng atlas PBR, vertex height-blend, sỏi rải và contact decal. Cỏ ven biển dùng density mask, bụi bảy lá instanced, wind shader và hai mức LOD theo camera/thiết bị. Hai mũi đồi hậu cảnh dùng radial LOD, PBR normal detail, màu theo cao độ, strata thủ tục, đá biến dạng và bụi cây instanced; mật độ tự giảm trên thiết bị yếu. Làng Địa Trung Hải dùng kit instanced gồm móng đá, tường vữa PBR, mái ngói, gờ tường, cửa kính, cửa gỗ và ống khói; hải đăng có thân thuôn, cửa sổ, ban công, lan can và phòng đèn emissive. Địa hình, làng bậc thang, thuyền buồm hai cánh có vệt nước và mây đều nằm trong không gian 3D — không còn lấy ảnh tĩnh làm nền hiển thị. Chi tiết cảnh xa dùng instancing và tự hạ mật độ biển/tắt SSAO trên thiết bị yếu hoặc renderer tự động để giữ thao tác mượt. Máy đủ mạnh dùng SSAO/contact shadow, bloom nhẹ và coastal color grading; cấu hình yếu giữ pipeline cân bằng. Nhà gameplay thêm mái dốc, ống khói, gờ sàn và bồn hoa gắn theo từng khối. Chi tiết trang trí không có collider riêng; hình khối chịu lực vẫn theo dữ liệu map. Cảnh nền không tham gia va chạm và dừng chuyển động khi bật reduced motion.
